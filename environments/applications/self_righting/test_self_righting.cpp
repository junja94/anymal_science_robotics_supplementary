...
int main(int argc, char *argv[]) {
  ...
  urdfPath +=
      "/home/joonho/workspace/oldrai/src/anymal_raisim/task/include/quadrupedLocomotion/model/robot_nofan_nolimit.urdf";
  actuatorPath = "/home/joonho/workspace/oldrai/src/anymal_raisim/data/seaModel_10000.txt";

  Task_ task(0, true, 3, actuatorPath, urdfPath);
...
//
  ...
  for (int iterationNumber = 0; iterationNumber < max; iterationNumber++) {
    ...
    /// Keyboard Inputs
    if (env_->getEvent(rai_graphics::KeyboardEvent::I)) {
      task.init();
